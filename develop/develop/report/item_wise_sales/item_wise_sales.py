...
def get_columns(additional_table_columns, filters):
    ...
    columns += [
        {"label": _("Receivable Account"), "fieldname": "debit_to", "fieldtype": "Link", "options": "Account", "width": 80},
    ...
    columns += [
        ...
        {"label": _("Cost Center"), "fieldname": "cost_center", "fieldtype": "Link", "options": "Cost Center", "width": 100},
        ...
        {"label": _("Sales UOM"), "fieldname": "sales_uom", "fieldtype": "Link", "options": "UOM", "width": 100},
...
def add_sub_total_row(item, total_row_map, group_by_value, tax_columns):
    ...
    total_row["percent_gt"] += item.get("percent_gt", 0.0)

    for tax in tax_columns:
        total_row.setdefault(frappe.scrub(tax + " Amount"), 0.0)
        total_row[frappe.scrub(tax + " Amount")] += flt(item.get(frappe.scrub(tax + " Amount"), 0.0))
